...
static asn_enc_rval_t
maxMessageLength_3_encode_xer(const asn_TYPE_descriptor_t *td, void *structure,
...
static const asn_TYPE_operation_t asn_CHOICE_maxMessageLength_3 = {
...
asn_TYPE_descriptor_t asn_DEF_maxMessageLength_3 = {
	...
	{ 0, 0, maxMessageLength_3_constraint },
...
static asn_TYPE_member_t asn_MBR_PrefixFingerprintContents_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PrefixFingerprintContents, maxMessageLength),
		...
		0,
		{ 0, 0, memb_maxMessageLength_constraint_1},
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"maxMessageLength"
		},
...
asn_TYPE_descriptor_t asn_DEF_PrefixFingerprintContents = {
	...
	"PrefixFingerprintContents",
	&asn_CHOICE_PrefixFingerprintContents,
