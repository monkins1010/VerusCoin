...
uint256 parse_string_to_256(const std::string & s)
{
    if (s.size() % 2 != 0) std::abort();
    uint256 result;
    unsigned char* p1 = (unsigned char*)&result;
    for (std::size_t i = 0; i != s.size() / 2; ++i)
        p1[i] = 16 * parse_hex(s[2 * i]) + parse_hex(s[2 * i + 1]);
    return result;
}
...
std::vector<unsigned char> CPATRICIABranch<CHashWriter>::verifyStorageProof(){
    ...
    else printf("PATRICIA Tree proof Account Matches\n");
    //run the storage proof
    std::vector<unsigned char> storageValue;
    try{
    std::vector<unsigned char> storageProofKey_v(storageProofKey.begin(),storageProofKey.end());


    storageValue = verifyProof(storageHash,storageProofKey_v,storageProof);
    ...
    printf("PATRICIA Tree proof StorageValues Match\n");
    return storageValue;
}
...
bool CETHPATRICIABranch::testProof(){
    ...
    stateRoot = parse_string_to_256("a9d1bce0a863561e3adcb06e2478cd7c9c1eefb654d708918d704e7221739bcf");
    accountProof = {parse_string(""),
    parse_string(""),
    parse_string(""),
    parse_string(""),
    parse_string(""),
    parse_string(""),
    parse_string("f86f9e20feda63703b859c5fc1532f295f0dab86866128afb4de81221e2eaba2fab84ef84c01884e6d18756ab00000a05c81bf03ee49db55e3322bcda7eb3e48512b42d20d51940abea4c4d4bf3fcfeda0f7e52f2aa71e4aef0374d93451708c24910b5e76ddeacff99d36251308128046"),
    };
    ...
    nonce = (1);
    storageHash = parse_string_to_256("5c81bf03ee49db55e3322bcda7eb3e48512b42d20d51940abea4c4d4bf3fcfed");

    uint256 storageKey = parse_string_to_256("0175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9");    
    CKeccack256Writer key_hasher;
    key_hasher.write((const char *)&(storageKey),32);
    storageProofKey = key_hasher.GetHash();

   
    storageProof = {parse_string(""),
        parse_string(""),
        parse_string("f843a020ac7d4e10f072d9f46be3db644ef1be450423557f8fa8d52ccc7cf0d7e8c319a1a0731530f68a3d73eb14e83696ba04cb85f3b268f14e8b7232613e6804dcd05255")};
    storageProofValue = (parse_string("731530f68a3d73eb14e83696ba04cb85f3b268f14e8b7232613e6804dcd05255"));
    
    std::vector<unsigned char> storageProved = verifyStorageProof();
    
    return verifyStorageValue(storageProved);
